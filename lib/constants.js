module.exports = {
    ...
    NUMERICINFO     : String.fromCharCode(71), //G
    GENERALINFO     : String.fromCharCode(72), //H
    ...
    UNKNOWN_MESSAGE : String.fromCharCode(118), //v
    ...
    FIELD_SEPARATOR: String.fromCharCode(2),
    RECORD_SEPARATOR: String.fromCharCode(3)
}
