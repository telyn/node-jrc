...
var Client = function(server,stream) {
    this.name = null;
    this.client = null;
    this.room = null;
    this.server = server;
...
//    stream.setTimeout(180000);
                        ...
                        switch(message.subcommand) {
                            ...
                            case constants.ROOMUSERLIST:
                                if(message.params[0] === "") {
                                    ...
                                    server.sendRoomUserList(self, message.params[0]);
                                }
                                break;
                        }
                        break;
    ...
    this.receiveServerUserCount = function(count) {
        self.send([constants.GENERALINFO,constants.USERINFO],"","a"+count); // ?? Ga\t\ta2 why does JRNet expect the subsubcommand to be here?
    };
