...
describe('Server-bound Messages',function() {
    ...
    describe('That Are Totally Optional', function() {
        it('should correctly parse mail inbox requests', function() {
        ...
        it('should correctly parse mail count requests', function() {
        ...
        it('should correctly parse mail sending requests', function() {
    ...
    describe('That I Don\'t Know The Purpose Of', function() {
        ...
        it('should correctly parse requests for the user count', function() {
        ...
        it('should correctly parse requests for the room count', function() {
        ...
        it('should correctly parse requests for the user count for a room', function() {
...
describe('Client-bound Messages', function() {
    describe('That Are Really Necessary For Communication', function() {
        ...
        it('should correctly parse incoming "(some person) joined (some room)" messages',function() {
        ...
        it('should correctly parse incoming "Someone left (some room) messages', function() {
        ...
        it('should correctly parse incoming user list', function() {
        ...
        it('should correctly parse incoming room list', function() {
        ...
        it('should correctly parse incoming users-in-room list', function() {
        ...
        it('should correctly parse incoming whois', function() {
    ...
    describe('That Are Totally Optional', function() {
        it('should correctly parse incoming mail', function() {
